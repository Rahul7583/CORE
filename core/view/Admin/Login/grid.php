  ...
  <div class="container-fluid h-custom">
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-md-9 col-lg-6 col-xl-5">
        <img src="skin\assets\dist\img\login.webp" class="img-fluid" alt="Sample image">
      </div>
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
        <form method="POST" action="<?php echo $this->getUrl('loginPost','admin_login');?>">
          ...
          <div class="form-outline mb-4">
            <input type="email" name="login[email]" id="form3Example3" class="form-control form-control-lg"
