...
class Model_Order extends Model_Core_Row
{
	...
	const STATUS_ENABLED_LBL = 'Pending';
	const STATUS_DISABLED_LBL = 'Processing';

	const STATE_ENABLED = 1;
	const STATE_DISABLED = 2;
	const STATE_DISABLED_DEFAULT = 1;
	const STATE_ENABLED_LBL = 'Pending';
	const STATE_DISABLED_LBL = 'Processing';
